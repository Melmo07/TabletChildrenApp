...
function setup() {
  ...
  var myAnimation = Dog.addAnimation("walking", "assets/dog_walk_00000.png", "assets/dog_walk_00019.png");
  ...
  Dog.addAnimation("sitting", "assets/sitting_dog_00000.png", "assets/sitting_dog_00019.png");

  Dog.onMousePressed = function() {
    Dog.changeAnimation("sitting");
  }
